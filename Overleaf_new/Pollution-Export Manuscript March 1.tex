...
regression of exports becomes independent of production activities, thus effectively eliminating estimation bias. The F-statistic of the Kleibergen-Paap (KP) Wald test for weak IV identification \citep{kleibergen2006generalized} 
is much larger than the 10\% critical value (16.38)
% of Stock-Yogo weak ID
% test \citep{stock2005asymptotic}, 
suggesting that thermal inversion is
